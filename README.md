...
- **24 Built-in Rules** — Performance, style, and security checks run instantly without API calls
...
This runs all 24 built-in rules instantly without requiring any API keys.
